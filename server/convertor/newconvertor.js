...
Handlebars.registerHelper("orion", function(str) {
  if (!str) return "";
  if (typeof str !== "string") return "";
  return stateOrionList[str] || str;
});
Handlebars.registerHelper("officeaddres", function(str) {
  if (!str) return "";
  if (typeof str !== "string") return "";
  return OfficeAddress[capitalize(str)] || str;
});

Handlebars.registerHelper("secretaryname", function(str) {
  if (!str) return "";
  if (typeof str !== "string") return "";
  return (OfficeAddress[capitalize(str)] || "").split(" ")[0];
});

Handlebars.registerHelper("genderman", function(gender) {
  if (!gender) return "";
...
Handlebars.registerHelper("gendermanhisher", function(gender) {
  if (!gender) return "";
  if (gender.toLowerCase() === "male") {
    return "his";
  } else if (gender.toLowerCase() === "female") {
...
Handlebars.registerHelper("genderheshe", function(gender) {
  if (!gender) return "";
  if (gender.toLowerCase() === "male") {
    return "he";
  } else if (gender.toLowerCase() === "female") {
...
Handlebars.registerHelper("currentmonth", function() {
  const months = [
    "January",
    "February",
    "March",
...
const noticeFile = {
  "./htmlfiles_black/DC IRS NOTICE - Letter - 09-22-2024nbGWC.html":`DC IRS NOTICE - Letter - ${formattedDate}nbGWC.pdf`,
  "./htmlfiles_black/SOS NOTICE - Letter - 09-20-2024nb 2 GWC.html":`SOS NOTICE - Letter - ${formattedDate}nb 2 GWC.pdf`,
  "./htmlfiles_black/SOSOS NOTICE - Letter - 09-22-2024nb GWC.html":`SOSOS NOTICE - Letter - ${formattedDate}nb GWC.pdf`,
}



function fileName(firstName, middleName, lastName, fileName) {
  ...
  const nameMappings = {
    "./htmlfiles_black/Act of Expatriation and Oath of Allegiance (JOHN MARK DOE).html": `${uppercase(firstName)} ${uppercase(middleName)} ${uppercase(lastName)}`,
    "./htmlfiles_black/Act of Expatriation and Oath of Allegiance (JOHN M. DOE).html": `${uppercase(firstName)} ${firstChar(middleName)} ${uppercase(lastName)}`,
    "./htmlfiles_black/Act of Expatriation and Oath of Allegiance (JOHN DOE).html": `${uppercase(firstName)} ${uppercase(lastName)}`,
  };
  ...
  if (nameMapping) {
    ...
    const newFileName = fileBaseName.replace(/(?<=\().+?(?=\))/g, nameMapping) + ".pdf";
    return newFileName;
  } else {
 ...
 * 
 * @param {Object} data - User information for replacing data from the HTML file.
 * @param {String} emailAddress - User email.
 * 
 * @returns {Promise<boolean>} - sucess ture and false errror.
 */

const newConvertor = async (data, emailAddress) => {
  let templates = [
    {
      tempUrl: "./htmlfiles_black/Act of Expatriation and Oath of Allegiance (JOHN DOE).html",
      header: ()=>"",footer: (data) => `
    ...
    {
      tempUrl: "./htmlfiles_black/Act of Expatriation and Oath of Allegiance (JOHN M. DOE).html",
      header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px; padding-top: 5px;">
          <tr>
    ...
    {
      tempUrl: "./htmlfiles_black/Act of Expatriation and Oath of Allegiance (JOHN MARK DOE).html",
      header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px; padding-top: 5px;">
          <tr>
    ...
    {tempUrl:"./htmlfiles_black/Autograph, Ink Instructions, etc For 928's.html",header: ()=>"", footer:(data)=>""},
    {
      tempUrl: "./htmlfiles_black/Cancellation of All Prior Powers of Attorney.html",
      header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px;  padding-top: 5px;">
          <tr>
    ...
    {tempUrl:"./htmlfiles_black/Certificate of Assumed Name - Notice of Transfer of Reserved Name.html",
      header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px;  padding-top: 5px;">
          <tr>
    ...
    {tempUrl:"./htmlfiles_black/Common Carry Declaration.html", header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px;  padding-top: 5px;">
          <tr>
            <td style="text-align: left;">
    ...
    {tempUrl:"./htmlfiles_black/Cover Sheet (1).html",header: ()=>"",footer:(data)=>""},
    {tempUrl:"./htmlfiles_black/Declaration of Political Status.html",header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px;  padding-top: 5px;">
          <tr>
            <td style="text-align: left;">
    ...
    {tempUrl:"./htmlfiles_black/Declaration of the Naturalization Act of July 1779.html", header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px;  padding-top: 5px;">
          <tr>
            <td style="text-align: left;">
    ...
    {tempUrl:"./htmlfiles_black/Fee Schedule - Notice of Intent.html",header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px;  padding-top: 5px;">
          <tr>
            <td style="text-align: left;">
    ...
    {tempUrl:"./htmlfiles_black/Mandatory Notice-Foreign Sovereign Immunity Act (FSIA).html", header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px;  padding-top: 5px;">
          <tr>
            <td style="text-align: left;">
    ...
    {tempUrl:"./htmlfiles_black/Paramount Claim of the Life and the Estate.html",header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px;  padding-top: 5px;">
          <tr>
            <td style="text-align: left;">
    ...
    {tempUrl:"./htmlfiles_black/SOSOS NOTICE - Letter - 09-22-2024nb GWC.html",header: (data)=>`<div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
    ...
    {tempUrl:"./htmlfiles_black/DC IRS NOTICE - Letter - 09-22-2024nbGWC.html",header: (data)=>`<div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
			<h1 style="text-align: center;font-size:30px">${capitalize(data?.firstName)} ${capitalize(data?.middleName)} ${capitalize(data?.lastName)}©</h1>
			<p style="text-align: center;font-size:18px;font-family: Calibri;margin: 0;">${capitalize(data.address1)}, ${capitalize(data.address2)} </p>
			<p style="text-align: center;font-size:18px;font-family: Calibri;margin: 0;">${capitalize(data.city)}, ${capitalize(data.state)} [${data.zipCode}] </p>
		</div>`,
      footer:(data)=>`<p style="width: 100%; padding: 0 10px; box-sizing: border-box;text-align: center;font-size: 10px;">${capitalize(data?.firstName)} ${capitalize(data?.middleName)} ${capitalize(data?.lastName)}</p></div>`},
    {tempUrl:"./htmlfiles_black/Witness Testimony (1).html",header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px;  padding-top: 5px;">
          <tr>
            <td style="text-align: left;">
    ...
    {tempUrl:"./htmlfiles_black/Witness Testimony (2).html",header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px;  padding-top: 5px;">
          <tr>
            <td style="text-align: left;">
    ...
    {tempUrl:"./htmlfiles_black/baby/1779-Declaration-for-American-federal-Employees.html",header: ()=>"",footer:(data)=>""},
    {tempUrl:"./htmlfiles_black/baby/Baby Deed Cover Letter -IFC.html",header: ()=>"",footer:(data)=>""},
    {tempUrl:"./htmlfiles_black/baby/Declaration for Naturalized Immigrants.html",header: ()=>"",footer:(data)=>""},
    {tempUrl:"./htmlfiles_black/baby/Declaration of Green Card Legal Immigrant.html",header: ()=>"",footer:(data)=>""},
  ];

  const sosDeed = [{tempUrl:"./htmlfiles_black/SOS NOTICE - Letter - 09-20-2024nb 2 GWC.html",header: ()=>`<div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
			<h1 style="text-align: center;font-size:30px">${capitalize(data?.firstName)} ${capitalize(data?.middleName)} ${capitalize(data?.lastName)}©</h1>
			<p style="text-align: center;font-size:18px;font-family: Calibri;margin: 0;">${capitalize(data.address1)}, ${capitalize(data.address2)}</p>
			<p style="text-align: center;font-size:18px;font-family: Calibri;margin: 0;">${capitalize(data.city)}, ${capitalize(data.state)} [${data.zipCode}] </p>
		</div>
`,footer:(data)=>`<p style="width: 100%; padding: 0 10px; box-sizing: border-box;text-align: center;font-size: 10px;">${capitalize(data?.firstName)} ${capitalize(data?.middleName)} ${capitalize(data?.lastName)}</p></div>`}];
  ...
  const babyDeed = [{tempUrl:"./htmlfiles_black/baby/Baby Deed of Land Recording.html",header: ()=>"",footer:(data)=>""}];
  ...
  const BornInMilitary = [
    {tempUrl:"./htmlfiles_black/Acknowledgment, Acceptance and Deed of Conveyance Adopted.html",header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px;  padding-top: 5px;">
          <tr>
            <td style="text-align: left;">
    ...
    {tempUrl:"./htmlfiles_black/Acknowledgment, Acceptance and Deed of Conveyance Naturalized.html",
      header: ()=>"",footer: (data) => `
  <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
    <table style="width: 100%; font-size: 10px;  padding-top: 5px;">
      <tr>
  ...
  if (data.bornCountryStatus == "no") {
    data.bornCounty = data.county;
    data.bornCity = data.city;
    data.bornState = data.state;
  }
  ...
  if (data.bornCountryStatus == "no") {
    ...
    templates = [
      ...templates,
      {tempUrl:"./htmlfiles_black/Acknowledgment, Acceptance and Deed of Re-Conveyance.html",header: ()=>"",footer: (data)=>`
        <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px; padding-top: 5px;">
          <tr>
            <td style="text-align: left;">
  ...
  if(OfficeAddress[capitalize(data.state)]){
    templates = [
      ...templates,
      ...sosDeed
    ]
  ...
  const pdfBuffers = [];
  const emailPath = (emailAddress || "untitled").split("@")[0];
  const localDir = path.join(__dirname, "..", "pdfs", emailPath);
  let browser = null;
  const urls = [];
  let  primaryName = [{
    otherFirstName : data.firstName,
    otherMiddleName: data.middleName,
    otherLastName: data.lastName,
  }]
  let allNames = primaryName
  try {
    ...
    const conversionPromises = templates.map(async template => {
      ...
      const pdfBuffer = await convertHtmlToPdf(browser, htmlContent,template?.footer(data),template?.header(data));

      const pdfFilename = noticeFile[template.tempUrl] || fileName(data.firstName, data.middleName, data.lastName,template.tempUrl);
    ...
    if (data.childList && data.childList.length > 0) {
      childPromises = data.childList.map(async (child, index) => {
        const childData = { ...data, ...child }; // Merge child-specific data

        return Promise.all(
          babyDeed.map(async template => {
            const templatePath = path.join(__dirname, template.tempUrl);
            const templateContent = await fs.readFile(templatePath, "utf8");
            ...
            const pdfBuffer = await convertHtmlToPdf(browser, htmlContent,template?.footer(childData),template?.header(childData));

            const pdfFilename = `BabyDeed_${index + 1}_${path.basename(
              template.tempUrl,
              ".html"
            )}.pdf`;
            const pdfPath = path.join(localDir, pdfFilename);
    ...
    let NameAct = [];
    if (data.nameList && data.nameList.length > 0 || data.maidenNameRedio == "yes") {
      
      const ListOfName = data.maidenNameRedio == "yes"?[...(data.nameList || []),{
        otherFirstName : data.firstName,
        otherMiddleName: data.maidenName,
        otherLastName: data.lastName}]:(data.nameList||[])
      NameAct = ListOfName.map(async (names, index) => {

        return Promise.all(
          ActFiles.map(async template => {
            const templatePath = path.join(__dirname, template.tempUrl);
            const templateContent = await fs.readFile(templatePath, "utf8");
            const htmlContent = await generateHtmlContent(
              templateContent,
              {...data, 
                firstName : names.otherFirstName,
                middleName : names.otherMiddleName,
                lastName : names.otherLastName}
            );
            const headerFooter = {...data, 
              firstName : names.otherFirstName,
              middleName : names.otherMiddleName,
              lastName : names.otherLastName}
            const pdfBuffer = await convertHtmlToPdf(browser, htmlContent,template?.footer(headerFooter),template?.header(headerFooter));

            const pdfFilename =  fileName(
              names.otherFirstName,
              names.otherMiddleName,
              names.otherLastName,template.tempUrl)
