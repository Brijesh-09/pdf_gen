...
function fileName(firstName, middleName, lastName, fileName) {
  ...
  const nameMappings = {
    "./htmlfiles/Act of Expatriation and Oath of Allegiance (JOHN MARK DOE).html": `${uppercase(firstName)} ${uppercase(middleName)} ${uppercase(lastName)}`,
    "./htmlfiles/Act of Expatriation and Oath of Allegiance (JOHN M. DOE).html": `${uppercase(firstName)} ${firstChar(middleName)} ${uppercase(lastName)}`,
    "./htmlfiles/Act of Expatriation and Oath of Allegiance (JOHN DOE).html": `${uppercase(firstName)} ${uppercase(lastName)}`,
  };
...
const convertor = async (data, emailAddress) => {
  let templates = [
    {
      tempUrl: "./htmlfiles/Act of Expatriation and Oath of Allegiance (JOHN DOE).html",
      header: ()=>"",footer: (data) => `
    ...
    {
      tempUrl: "./htmlfiles/Act of Expatriation and Oath of Allegiance (JOHN M. DOE).html",
      header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px; padding-top: 5px;">
          <tr>
    ...
    {
      tempUrl: "./htmlfiles/Act of Expatriation and Oath of Allegiance (JOHN MARK DOE).html",
      header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px; padding-top: 5px;">
          <tr>
    ...
    {tempUrl:"./htmlfiles/Autograph, Ink Instructions, etc For 928's.html",header: ()=>"", footer:(data)=>""},
    {
      tempUrl: "./htmlfiles/Cancellation of All Prior Powers of Attorney.html",
      header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px;  padding-top: 5px;">
          <tr>
    ...
    {tempUrl:"./htmlfiles/Certificate of Assumed Name - Notice of Transfer of Reserved Name.html",
      header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px;  padding-top: 5px;">
          <tr>
    ...
    {tempUrl:"./htmlfiles/Common Carry Declaration.html", header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px;  padding-top: 5px;">
          <tr>
            <td style="text-align: left;">
    ...
    {tempUrl:"./htmlfiles/Cover Sheet (1).html",header: ()=>"",footer:(data)=>""},
    {tempUrl:"./htmlfiles/Declaration of Political Status.html",header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px;  padding-top: 5px;">
          <tr>
            <td style="text-align: left;">
    ...
    {tempUrl:"./htmlfiles/Declaration of the Naturalization Act of July 1779.html", header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px;  padding-top: 5px;">
          <tr>
            <td style="text-align: left;">
    ...
    {tempUrl:"./htmlfiles/Fee Schedule - Notice of Intent.html",header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px;  padding-top: 5px;">
          <tr>
            <td style="text-align: left;">
    ...
    {tempUrl:"./htmlfiles/Mandatory Notice-Foreign Sovereign Immunity Act (FSIA).html", header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px;  padding-top: 5px;">
          <tr>
            <td style="text-align: left;">
    ...
    {tempUrl:"./htmlfiles/Paramount Claim of the Life and the Estate.html",header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px;  padding-top: 5px;">
          <tr>
            <td style="text-align: left;">
    ...
    {tempUrl:"./htmlfiles/SOSOS NOTICE - Letter - 09-22-2024nb GWC.html",header: (data)=>`<div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
    ...
    {tempUrl:"./htmlfiles/DC IRS NOTICE - Letter - 09-22-2024nbGWC.html",header: (data)=>`<div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
			<h1 style="text-align: center;font-size:30px">${capitalize(data?.firstName)} ${capitalize(data?.middleName)} ${capitalize(data?.lastName)}©</h1>
			<p style="text-align: center;font-size:18px;font-family: Calibri;margin: 0;">${capitalize(data.address1)}, ${capitalize(data.address2)} </p>
			<p style="text-align: center;font-size:18px;font-family: Calibri;margin: 0;">${capitalize(data.city)}, ${capitalize(data.state)} [${data.zipCode}] </p>
		</div>`,
      footer:(data)=>`<p style="width: 100%; padding: 0 10px; box-sizing: border-box;text-align: center;font-size: 10px;">${capitalize(data?.firstName)} ${capitalize(data?.middleName)} ${capitalize(data?.lastName)}</p></div>`},
    {tempUrl:"./htmlfiles/Witness Testimony (1).html",header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px;  padding-top: 5px;">
          <tr>
            <td style="text-align: left;">
    ...
    {tempUrl:"./htmlfiles/Witness Testimony (2).html",header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px;  padding-top: 5px;">
          <tr>
            <td style="text-align: left;">
    ...
    {tempUrl:"./htmlfiles/baby/1779-Declaration-for-American-federal-Employees.html",header: ()=>"",footer:(data)=>""},
    {tempUrl:"./htmlfiles/baby/Baby Deed Cover Letter -IFC.html",header: ()=>"",footer:(data)=>""},
    {tempUrl:"./htmlfiles/baby/Declaration for Naturalized Immigrants.html",header: ()=>"",footer:(data)=>""},
    {tempUrl:"./htmlfiles/baby/Declaration of Green Card Legal Immigrant.html",header: ()=>"",footer:(data)=>""},
  ];

  const sosDeed = [{tempUrl:"./htmlfiles/SOS NOTICE - Letter - 09-20-2024nb 2 GWC.html",header: ()=>`<div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
			<h1 style="text-align: center;font-size:30px">${capitalize(data?.firstName)} ${capitalize(data?.middleName)} ${capitalize(data?.lastName)}©</h1>
			<p style="text-align: center;font-size:18px;font-family: Calibri;margin: 0;">${capitalize(data.address1)}, ${capitalize(data.address2)}</p>
			<p style="text-align: center;font-size:18px;font-family: Calibri;margin: 0;">${capitalize(data.city)}, ${capitalize(data.state)} [${data.zipCode}] </p>
		</div>
`,footer:(data)=>`<p style="width: 100%; padding: 0 10px; box-sizing: border-box;text-align: center;font-size: 10px;">${capitalize(data?.firstName)} ${capitalize(data?.middleName)} ${capitalize(data?.lastName)}</p></div>`}];
  ...
  const babyDeed = [{tempUrl:"./htmlfiles/baby/Baby Deed of Land Recording.html",header: ()=>"",footer:(data)=>""}];
  ...
  const BornInMilitary = [
    {tempUrl:"./htmlfiles/Acknowledgment, Acceptance and Deed of Conveyance Adopted.html",header: ()=>"",footer: (data) => `
      <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px;  padding-top: 5px;">
          <tr>
            <td style="text-align: left;">
    ...
    {tempUrl:"./htmlfiles/Acknowledgment, Acceptance and Deed of Conveyance Naturalized.html",
      header: ()=>"",footer: (data) => `
  <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
    <table style="width: 100%; font-size: 10px;  padding-top: 5px;">
      <tr>
  ...
  if (data.bornCountryStatus == "no") {
    ...
    templates = [
      ...templates,
      {tempUrl:"./htmlfiles/Acknowledgment, Acceptance and Deed of Re-Conveyance.html",header: ()=>"",footer: (data)=>`
        <div style="font-size: 10px; width: 100%; padding: 0 10px; box-sizing: border-box;">
        <table style="width: 100%; font-size: 10px; padding-top: 5px;">
          <tr>
            <td style="text-align: left;">
